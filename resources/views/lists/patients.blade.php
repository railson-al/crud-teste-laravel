        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    data-bs-target="#createPatientModal">Novo Paciente</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    @foreach($patients as $patient)
                            ...
                            <tbody>
                                ...
                                <td>{{$patient->phone}}</td>
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-warning waves-effect"
                                    data-bs-toggle="modal" 
                                    ...
                                    <form id="patients-form-edit" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="file_path-edit" type="file" class="form-control-file" name="file_path" required autocomplete="file_path">
                                                </div>
                                            </div>
